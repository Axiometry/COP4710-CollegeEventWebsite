...
import models.services.mysql._
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  def configure() {
    ...
    bind[UniversityService].to[MysqlUniversityService]
    bind[UserService].to[MysqlUserService]
    bind[EventService].to[MysqlEventService]
    bind[RsoService].to[MysqlRsoService]
    bind[RsoMembershipService].to[MysqlRsoMembershipService]
    bind[EventCommentService].to[MysqlEventCommentService]
